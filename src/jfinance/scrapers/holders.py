# このファイルは yfinance 1.5.2 の `scrapers/holders.py` を tools/vendor_yfinance.py がコピーして作った。手で直さない。
...
from jfinance.const import _BASE_URL_
from jfinance.data import YfData
from jfinance.exceptions import YFDataException
