# このファイルは yfinance 1.5.2 の `search.py` を tools/vendor_yfinance.py がコピーして作った。手で直さない。
# 元: https://github.com/ranaroussi/yfinance （Apache License 2.0, Copyright 2017-2019 Ran Aroussi）
# 中身: Search
# 変えた点（Apache License 2.0 第 4 条 b）:
#   - 削った: Search.news, Search.lists, Search.research, Search.nav（ニュース・リスト・リサーチ・ナビ（EDINET に無い））
#   - 名前 yfinance → jfinance（import・ロガー名・repr）
#   - 差し替えた: all にはあるものだけを入れる
